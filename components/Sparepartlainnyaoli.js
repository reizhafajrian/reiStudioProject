  ...
  return (
    <CRow>
      ...
      >
          ...
          <Image src={OLI} width={192} height={192} objectFit={"cover"} />
      ...
      >
        ...
        <CCard style={{width: "12rem", alignItems: "center" }}>
          <Image src={PRODUK_4} width={136} height={126} objectFit={"cover"}/>
          <CCardBody
            className={
...
export default function Sparepartlainnyaoli({ type = true }) {
  return (
    <>
